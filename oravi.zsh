...
ORAVI_EXIT_PREFIX="${ORAVI_EXIT_PREFIX:-" X$ORAVI_EXIT_SYMBOL "}"
ORAVI_EXIT_SUFFIX="${ORAVI_EXIT_SUFFIX:-">"}"
ORAVI_EXIT_COLOR="${ORAVI_EXIT_COLOR:-"red"}"
# }}}
# Git {{{
ORAVI_GIT_SYMBOL="${ORAVI_GIT_SYMBOL:-"Git:"}"
...
ORAVI_GIT_STATUS_DELETED="${ORAVI_GIT_STATUS_DELETED:-"x"}"
...
# }}}
# PyEnv {{{
ORAVI_PYENV_SYMBOL="${ORAVI_PYENV_SYMBOL:-"Python:"}"
...
# }}}
# SwiftEnv {{{
ORAVI_SWIFTENV_SYMBOL="${ORAVI_SWIFTENV_SYMBOL:-"Swift:"}"
...
# }}}
# GoEnv {{{
ORAVI_GOENV_SYMBOL="${ORAVI_GOENV_SYMBOL:-"Go:"}"
...
# }}}
# RbEnv {{{
ORAVI_RBENV_SYMBOL="${ORAVI_RBENV_SYMBOL:-"Ruby:"}"
